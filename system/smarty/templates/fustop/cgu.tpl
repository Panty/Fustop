...
{block name=title}Conditions générales d'utilisation{/block}
{block name=body}
<div class="titlenews">C.G.U</div>
	<div class="well well-small">
		<b><font color="red">En vous inscrivant et en jouant sur {$TITLE}, vous déclarez avoir lu et accepté la présente charte. Il vous est donc impossible
		...
		<br><br>
		<img src="{$URL_ASSETS}images/livre.png" style="float: right;">
...
<div class="titlenews"><img width="16" height="16" style="float: left;" src="{$URL_ASSETS_GLOBAL}devtool/help.png"> Qui contacter et comment ?</div>
	<div class="well well-small">
...
<div class="titlenews"><img width="16" height="16" style="float: left;" src="{$URL_ASSETS_GLOBAL}devtool/money.png"> Transactions :</div>
	<div class="well well-small">
...
<div class="titlenews"><img width="16" height="16" style="float: left;" src="{$URL_ASSETS_GLOBAL}devtool/user.png"> Pseudonymes :</div>
	<div class="well well-small">
		...
		&nbsp;&nbsp;- Publicité
		<br>
		Toute <b>publicité</b> pour un autre serveur ou leur mention (pour faire l'éloge ou la diatribe) est <font color="red">interdite</font>. Dans le cas contraire vous risquez une suspension définitive de vôtre compte. Nous sommes sur <!--?php echo {$TITLE} - Serveur priver Dofus 1.29; ?-->, les autres serveurs ne nous concernent pas.
		<br><br>
...
<div class="titlenews"><img width="16" height="16" style="float: left;" src="{$URL_ASSETS_GLOBAL}devtool/newspaper.png"> Charte en jeu :</div>
	<div class="well well-small">
...
<div class="titlenews"><img width="16" height="16" style="float: left;" src="{$URL_ASSETS_GLOBAL}devtool/set_security_question.png"> Guildes :</div>
	<div class="well well-small">
...
<div class="titlenews"><img width="16" height="16" style="float: left;" src="{$URL_ASSETS_GLOBAL}devtool/comment.png"> Canaux de discussions :</div>
	<div class="well well-small">
...
<div class="titlenews"><img width="16" height="16" style="float: left;" src="{$URL_ASSETS_GLOBAL}devtool/ip.png"> Sanctions :</div>
	<div class="well well-small">
		...
		<br>
		Tout comportement contraire à l'éthique de {$TITLE} pourra être sanctionnée par l'équipe sans avertissement préalable.
		</fieldset>
		<br>	
</div><br />
{/block}