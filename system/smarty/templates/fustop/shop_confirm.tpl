...
{/if}
<div class="titlenews">Boutique : Confirmation</div>
	<div class="well well-small">
		<center>Veuillez vérifier les informations de la commande avant de continuer. Lisez bien les informations de cette page, elles peuvent vous être utiles.</center>
		<br /><br />
